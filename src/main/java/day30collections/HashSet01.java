...
public class HashSet01 {
    /*
    //Hash bir tekniktir,birbirine benzemeyen code'ler üretir bu code'ller data^yi unique yapar.
    ...
    public static void main(String[] args) {
        ...
        //******************************
        //var oan elemani ekerseniz hata vermez, son ekleneni var olan data'nın ustune yazar(Overwrite)
        emails.add("Mango");
