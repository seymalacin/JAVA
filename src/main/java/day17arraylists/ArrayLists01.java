...
public class ArrayLists01 {
    public static void main(String[] args) {
        ...
        names.add("Trump");
        names.add("Taceddin");
        System.out.println(names);//[Tom, Thoms, Tahsin, Trump, Taceddin]
        ...
        System.out.println(names);//[Thoms, Tahsin]
        System.out.println(cities);//[Trump, Tom, Taceddin]


        List<String> myNames = new ArrayList<>();
        boolean sonuc1 = names.containsAll(myNames);//Bir ıstin icinde coku eemanlarin var oup omadigini kontrol eder,
        ...
        //Example 1: "a" listinde "shoes" elemaninin ik gorunumunu siliniz
        a.remove("Shoes");
        System.out.println(a);//[TV, Radio, Laptop, Shoes, Book, Shoes]

        //Exampe 1: "a" listinde "shoes" elemaninin tum gorunumunu siliniz
        List<String> silinecekler = new ArrayList<>();
        silinecekler.add("Shoes");
        a.removeAll(silinecekler);
        System.out.println(a);//[TV, Radio, Laptop, Book]

        //Example 3: bir tane saary listi ousturun , eger saary 10000'den az ise %20 1000 'den cok is %10 zam yapiniz.
