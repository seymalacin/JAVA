...
public class StringBuffer01 {
    ...
    /*
     1)StringBuffer Java'da bir class'dir ve String olustrmaya yarar.
     2)StringBuffer Class, StringBuilder Class gibi "mutable" dir.

     StirngBuffer ile StringBuilder in farki nedir?
     1)StringBuffer "thread-safe" dir.
     2)StringBuffer "synchronized" dir


    SENARYOLAR:
    1)Degistirilemez data ici "String Clss" kulanilir
