...
public class Exceptions01 {
    ...
    public static int convertStringToInteger(String str) {
        int i = 0;
        try {
            //Herangi bir satirda "Exception" atilirsa java direkt "catch" bolumune gecer try icindeki sonraki kodlari calistirmaz
            i = Integer.valueOf(str);
            System.out.println("Burasi try bolumu");

        } catch (NumberFormatException e) {
            System.out.println("Reklam omayan karakter iceren String'ler Intager'a cevrilmez");
        }
        return i;
    }
}
